...
CREATE TABLE `tbltrade` (
  ...
  `COMPANYADDRESS` varchar(90) NOT NULL,
  `COMPANYCONTACTNO` varchar(30) NOT NULL,
  `EMPLOYEEPROFILE` varchar(90) NOT NULL,
  `NOOFEMPLOYEEAVAILABLE` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbltrade` (`COMPANYID`, `COMPANYNAME`, `COMPANYADDRESS`, `COMPANYCONTACTNO`, `EMPLOYEEPROFILE`, `NOOFEMPLOYEEAVAILABLE`) VALUES
(1, 'URC', 'Bry Camugao', '023654', 'Dev', '4'),
(2, 'Copreros', 'Mabinay\'s', '035656', 'Test Enginner', '1'),
(3, 'Quest', 'Kabankalan City', '23165', 'Dev2', '2'),
(4, 'Palacios Company', 'Kabankalan City', '0625656899', 'Dev1', '11'),
(5, 'IT Company', 'Kabankalan City', '04564123', 'Data Analyst', '2');
