...
<head>
<meta charset="utf-8">
<title>PLACERS / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+91) 8465485462</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Placers - (JOB PORTAL)<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='trade'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=trade">Employee trade</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>PLACERS</strong><br>
          Hebbal main Road, Near Manyata Tech Park<br>
           Bangalore.</address>
          <p>
            <i class="icon-phone"></i> +91 8465485462 <br>
            <i class="icon-envelope-alt"></i> placerscell@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy;  Apps@2022 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
