		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Any query just drop a message</h3>
									<p>If stuck with any of the problem or any queries the always 24*7 feel free to message or call
										to the number given.</p>
