...
?>
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <h1 class="page-header">Add Company Trade Details</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                 </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANYADDRESS">Employee Details:</label> 
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="EMPLOYEEPROFILE" name="EMPLOYEEPROFILE" placeholder=
                            "Trade Details" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"></textarea>
                         <!-- <input class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS" placeholder="Company Address"   autocomplete="none"/>  -->
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "NOOFEMPLOYEEAVAILABLE">Number Of Employees:</label>


                      <div class="col-md-8">
                         <input class="form-control input-sm" id="NOOFEMPLOYEEAVAILABLE" name="NOOFEMPLOYEEAVAILABLE        " placeholder=
                            "Number of Employees" type="text" value="" autocomplete="none">
                      </div>
                    </div>
                  </div>  
