...
switch ($action) {
 ...
 // `COMPANYNAME`, `COMPANYADDRESS`, `COMPANYCONTACTNO`
		if ( $_POST['COMPANYNAME'] == "" || $_POST['COMPANYADDRESS'] == "" || $_POST['COMPANYCONTACTNO'] == "" || $_POST['EMPLOYEEPROFILE'] == "" || $_POST['NOOFEMPLOYEEAVAILABLE'] == "" ) {
			$messageStats = false;
			...
			$company->EMPLOYEEPROFILE	= $_POST['EMPLOYEEPROFILE'];
			$company->NOOFEMPLOYEEAVAILABLE	= $_POST['NOOFEMPLOYEEAVAILABLE'];
