...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>PLACERS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PLACERS</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'trade') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/trade/">
            <i class="fa fa-building"></i> <span>Employee trade</span> 
          </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">Apps</a>.</strong> All rights
    reserved.
  </footer>
